...
_default_service = NarrativeManagementService()
...
async def create_narrative(
    ...
    """创建新的 L1 叙事（模块级委托）。"""
    return await _default_service.create_narrative(
...
async def get_narrative(
    ...
    """获取 L1 叙事详情（模块级委托）。"""
    return await _default_service.get_narrative(
...
async def list_narratives(
    ...
    """列出 L1 叙事（模块级委托）。"""
    return await _default_service.list_narratives(
...
async def update_narrative(
    ...
    """更新 L1 叙事（模块级委托）。"""
    return await _default_service.update_narrative(
...
async def submit_narrative(
    ...
    """提交 L1 叙事审核（模块级委托）。"""
    return await _default_service.submit_narrative(
        narrative_id, current_user, session,
    )
...
async def get_cards_by_narrative(
    ...
    """获取某叙事下的所有 L2 卡片（模块级委托）。"""
    return await _default_service.get_cards_by_narrative(
        narrative_id, session,
    )
