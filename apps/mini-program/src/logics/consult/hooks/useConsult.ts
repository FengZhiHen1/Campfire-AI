/**
 * CSLT-08 useConsult Hook —— CSLT-07 的唯一桥接接口。
 *
 * 职责：
 * - 通过 Zustand selector 读取 Store 状态
 ...
 * - 副作用统一在 Store action 或 SseStreamParser 事件回调中执行
 */
...
export function useConsult(): UseConsultReturn {
  // ==========================================================================
  // Zustand Store Selector（细粒度订阅，避免无关字段触发重渲染）
  // ==========================================================================
